...
import { useAdminFlightApplicationDetail } from "@/hooks/Admin/useBooking";

export default function AdminFlightBookingDetailContent() {
  const { id } = useParams();
  const { booking, isLoading, isError } = useAdminFlightApplicationDetail(id);
