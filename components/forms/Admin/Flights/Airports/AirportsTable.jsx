...
export default function AirportsTable() {
  ...
  const handleEdit = (item) => {
    router.push(`/admin/flights/airports/update/${item.id}`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Tour Airports</h1>
          <p className="text-gray-500 mt-1">
            Manage all tour Airports in your system
          </p>
        </div>
        <Link
      ...
      <DataTable
        ...
        config={{
          ...
          emptyMessage: "No tour airport found",
