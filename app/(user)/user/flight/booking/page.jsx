...
import { useFlightBookings } from "@/hooks/Page/useFlightBooking";
import FlightBookingStatsBar from "@/components/Page/User/FlightBooking/FlightBookingStatsBar";
import FlightBookingTable from "@/components/Page/User/FlightBooking/FlightBookingTable";
...
export default function FlightBookingsPage() {
  ...
  const { data: response, isLoading } = useFlightBookings(page);
